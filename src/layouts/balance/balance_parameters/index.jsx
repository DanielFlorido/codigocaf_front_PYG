...
const BalanceParameters = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      const fullUrl = `${ENDPOINTS.BALANCE_PARAMETERS_ID}${selectedId}`;
          ...
          <Grid container spacing={2} mt={4}>
            ...
            >
              ...
              >
                <MDButton
                  ...
                  onClick={() => {
                    ...
                    setTextModal((prevState) => ({
                      ...prevState,
                      newClassChild: "Agregar Nueva Clase",
                    }));
                ...
                >
                  <Icon sx={{ fontSize: 20, marginRight: 1 }}>add</Icon> Nueva Clase
                </MDButton>
              </MDBox>
            </Grid>
            <Grid
