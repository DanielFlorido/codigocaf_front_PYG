  ...
  return (
    <DashboardLayout>
      ...
      <Card>
        ...
        {filters.yearsMonth !== 2 && (filters.year || filters.dateTo) && cardData && (
          <MDBox pb={3} ml={3} mr={3}>
            <Grid container spacing={3}>
              {[cardData.balanceSheet, cardData.monthlyProfit, cardData.accumulatedProfit].map(
                (card, index) => (
                  <Grid item xs={12} sm={4} key={index}>
                    ...
                    >
                      <DefaultStatisticsCard title={card.title} count={card.value} />
                    </motion.div>
                  </Grid>
                )
              )}
