...
const ThirdParty = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      const fullUrl = `${ENDPOINTS.THRID_PARTY}${selectedId}`;
      ...
      <MDBox pt={4} pb={3}>
        <Card>
          <MDTypography variant="h3" fontWeight="medium" textAlign={"center"} mt={3}>
            Configuración parametros de terceros
          </MDTypography>
          <Grid container spacing={2} mt={4}>
            ...
            >
              ...
              >
                <MDButton
                  ...
                  onClick={() => {
                    ...
                    setTextModal((prevState) => ({
                      ...prevState,
                      newClassChild: "Agregar Nuevo Cliente",
                    }));
                ...
                >
                  <Icon sx={{ fontSize: 20, marginRight: 1 }}>add</Icon>Nuevo Cliente
                </MDButton>
              </MDBox>
            </Grid>
            <Grid
