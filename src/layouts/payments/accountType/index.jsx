...
const AccountType = () => {
  ...
  const confirmDelete = async () => {
    ...
    try {
      const fullUrl = `${ENDPOINTS.ACCOUNT_TYPE}${selectedId}`;
          ...
          <Grid container spacing={2} mt={4}>
            ...
            >
              ...
              >
                <MDButton
                  ...
                  onClick={() => {
                    ...
                    setTextModal((prevState) => ({
                      ...prevState,
                      newClassChild: "Agregar Nuevo Tipo Cuenta",
                    }));
                ...
                >
                  <Icon sx={{ fontSize: 20, marginRight: 1 }}>add</Icon> Nuevo Tipo Cuenta
                </MDButton>
              </MDBox>
            </Grid>
          </Grid>
